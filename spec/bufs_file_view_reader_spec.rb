...
module BufsFileReaderSpec
  LibDir = File.dirname(__FILE__) + '/../lib/'
end
  

require BufsFileReaderSpec::LibDir + 'bufs_file_view_reader'

ViewDir = BufsFixtures::ProjectLocation  + 'sandbox_for_specs/bufs_file_view_reader_spec/view_static/'
StaticModelFile = BufsFixtures::ProjectLocation  + 'sandbox_for_specs/bufs_file_view_reader_spec/model_static.json'
